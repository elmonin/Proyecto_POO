...
public class FrmAgregarPersona extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Persona objPersona = new Persona(txtCedula.getText(), txtNombre.getText(), txtApellido.getText(), txtDireccion.getText(), txtEmail.getText(), txtCelular.getText(), String.valueOf(txtContraseña.getPassword()), "");
        Conexion objConexion = new Conexion();
        objConexion.getConexion();
        if (objConexion.agregarPersona(objPersona) > 0) {
            JOptionPane.showMessageDialog(null, "La persona con cedula " + txtCedula.getText() + " se agrego correctamente");
